# -*- coding: utf-8 -*-
"""file profile cua toi

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1XF-l8CGC4cVMHlf3BPtSuRI_svpt1qB9
"""

from IPython.display import HTML
import base64

# Encode the welcome image
image_path = '/content/6fe31b6eb6ef60282b0e05dca6dd4418.jpg'
with open(image_path, "rb") as img_file:
    img_base64 = base64.b64encode(img_file.read()).decode('utf-8')

# Encode the MP3 file
audio_path = '/content/Sơn Tùng M-TP x Tyga - Come My Way (Acigode Remix).mp3'
...
<head>
    ...
    <style>
        ...
        .container {
            ...
            overflow: visible;
            transition: box-shadow 0.1s ease-out, border-width 0.1s ease-out;
        }
    ...
    <script>
        ...
        function visualize() {
            ...
            if(avg > 150) {
                ...
                // Draw lightning along borders randomly
...
display(HTML(html_code.replace('" + img_base64 + "', img_base64).replace('" + audio_base64 + "', audio_base64)))
